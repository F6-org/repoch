...
exports.default = function (oElement) {
    ...
    if (oElement.getBoundingClientRect) {
        // IE6+  FF3+ chrome9+ safari5+ opera11+
        if (conf.parent) {
...
var generalPosition = function generalPosition(el) {
...
var countPosition = function countPosition(el, shell) {
    var pos, parent;
...
function getRotate(el) {
    ...
    var tr = st.getPropertyValue("-webkit-transform") || st.getPropertyValue("-moz-transform") || st.getPropertyValue("-ms-transform") || st.getPropertyValue("-o-transform") || st.getPropertyValue("transform") || false;
