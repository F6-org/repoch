...
function diffShallow(api, actual, expected, theme, indent) {
  ...
  return {
    ...
    finalize: function finalize() {
      var namesAreEqual = actual.compareNames(expected);
      var actualName = actual.formatName(theme);
      var expectedName = expected.formatName(theme);

      var openTag = theme.react.openTag;
      var innerIndentation = indent.increase();

      var allChildren = childBuffer.withFirstPrefixed(innerIndentation);
      var children = allChildren.decompose();

      var allProperties = propertyBuffer.withFirstPrefixed(innerIndentation);
      var properties = allProperties.decompose();
...
//# sourceMappingURL=diffShallow.js.map