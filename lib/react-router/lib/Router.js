...
var propTypes = {
  ...
  createTransitionManager: function createTransitionManager() {
    ...
    (0, _invariant2.default)(history.getCurrentLocation, 'You have provided a history object created with history v4.x or v2.x ' + 'and earlier. This version of React Router is only compatible with v3 ' + 'history objects. Please change to history v3.x.');
